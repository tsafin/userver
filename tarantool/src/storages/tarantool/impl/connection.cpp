...
// Build the base64 decode table once at program startup.
// Using a function-static with initializer lambda guarantees thread-safe
// one-time construction under the C++11 static-initialization rules.
